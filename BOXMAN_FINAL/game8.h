#ifndef MAINWINDOW_H8
#define MAINWINDOW_H8
...
#define INTERFACE_WIDTH08 740 // 窗口宽度
#define INTERFACE_HEIGHT08 740 // 窗口高度
#define INTERFACE_WIDTH8 700 // 窗口宽度
#define INTERFACE_HEIGHT8 740 // 窗口高度
#define LINE8 7 // 地图行数
#define COLUMN8 8 // 地图列数
...
private:
    ...
    QHBoxLayout *L2;
public:
    explicit game8(QWidget *parent = nullptr);
    ~game8();
protected:
