#ifndef MAINWINDOW_H7
#define MAINWINDOW_H7
...
#define INTERFACE_WIDTH07 740 // 窗口宽度
#define INTERFACE_HEIGHT07 740 // 窗口高度
#define INTERFACE_WIDTH7 980 // 窗口宽度
#define INTERFACE_HEIGHT7 740 // 窗口高度
#define LINE7 8 // 地图行数
#define COLUMN7 11 // 地图列数
...
private:
    ...
    QHBoxLayout *L2;
public:
    explicit game7(QWidget *parent = nullptr);
    ~game7();
protected:
